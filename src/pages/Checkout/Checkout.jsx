...
function Checkout() {
  ...
  const onSubmit = (data) => {
    //dispatch();
    console.log(data);
    dispatch(updateUserAsync({ ...loggedInUser, addresses: [...loggedInUser.addresses, data] }));
    reset();
  };
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      {!items.length && <Navigate to="/" replace />}
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3">
          <form className="bg-white px-5 py-12 mt-12" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-12">
              ...
              <div className="flex items-center justify-end gap-x-6 my-0">
                <button type="button" className="text-sm font-semibold leading-6 text-gray-900">
                  Reset
                </button>
                <button
                  type="submit"
                  className="rounded-md bg-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Add Address
                </button>
              </div>
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <div className="mt-10 space-y-10">
                  <fieldset>
                    <legend className="text-3xl font-semibold leading-6 text-gray-900">Payment Methods</legend>
        ...
        <div className="lg:col-span-2">
          <div className="mx-auto mt-12 bg-white max-w-7xl px-0 sm:px-0 lg:px-0">
            <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
              <h1 className="text-3xl my-5 font-bold tracking-tight text-gray-900">Cart</h1>
                    ...
                    <li key={item.id} className="flex py-6">
                      ...
                      <div className="ml-4 flex flex-1 flex-col">
                        ...
                        <div className="flex flex-1 items-end justify-between text-sm">
                          <div>
                            <span htmlFor="quantity" className="mr-5 text-sm font-medium leading-6 text-gray-900">
                              Qty
                            </span>
